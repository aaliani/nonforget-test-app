        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          {status === "authenticated" ? (
                        ...
                        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                          <a class="mr-5 hover:text-gray-900" href="/user-area">Home</a>
                          <a class="mr-5 hover:text-gray-900" href="/discover">Discover</a>
                          <a class="mr-5 hover:text-gray-900" href="/get-packs">Get Packs</a>
                          <a class="mr-5 hover:text-gray-900" href="/leaderboard">Leaderboard</a>
                          <a class="mr-5 hover:text-gray-900" href="/memodex">Memodex</a>
                        </nav>
                      </div>
          ) : (
<div className="flex">
      ...
      className={`absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden ${menuOpen ? "block" : "hidden"}`}
    >
